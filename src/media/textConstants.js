export const content = {
  guildInfoSections:[
    ...
    descriptionContent:[
      ...
      "PROGRESSION Tue/Wed/Mon 7:30-10:30 PM EST (server time)",
      ...
      "FARM CONTENT",
      "Tuesday 7:30 - 10:30 EST (server time)",
      "Wednesday (if needed) 7:30 - 10:30 EST* (server time)* ",
  ...
  {
    titleContent:"CHANGELOG",
    descriptionContent:["9/22 - Added clarification for content launch week raid times under Schedule section."]
  }
],
